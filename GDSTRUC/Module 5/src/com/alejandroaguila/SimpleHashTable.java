...
import com.alejandroaguila.StoredPlayer;
...
public class SimpleHashTable {
    ...
    public void put(String key, Player value)
    {
        ...
        if (isOccupied(hashedKey))
        {
            System.out.println("ELEMENT EXISTS AT POSITION " + hashedKey);
        }
    ...
    public Player remove(String key)
    {
        ...
        System.out.println(hashtable[hashedKey].value + " has been removed at Element " + hashedKey + "\n");
